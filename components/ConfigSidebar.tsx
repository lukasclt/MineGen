...
import { Settings, Database, Coffee, Tag, Cpu, Download, Github, AlertCircle, Loader2, MessageSquare, Plus, Trash2, Sliders } from 'lucide-react';
...
const ConfigSidebar: React.FC<ConfigSidebarProps> = ({ 
  ...
  const handleDisconnect = () => {
    setSettings(prev => ({ ...prev, github: undefined }));
    setTokenInput('');
  };
              ...
              {!settings.github?.isConnected ? (
                <div className="space-y-2">
                  <p className="text-[10px] text-gray-400 leading-tight">
                    Token (Classic) com permissões <b>repo</b> e <b>workflow</b>.
                  </p>
                  <input
                    type="password"
                    value={tokenInput}
                  ...
                  <div className="flex items-center justify-between bg-green-900/20 border border-green-800 rounded p-2">
                    <div className="flex items-center gap-2">
                       ...
                       <div className="flex flex-col">
                          <span className="text-xs font-bold text-green-400">@{settings.github.username}</span>
                       </div>
                    </div>
